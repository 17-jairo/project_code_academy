...
marina_age = {'Marina': 27}.get('Marina')
print(marina_age)
...
medical_records["Connie"] = {"Age": 43, "Sex": "Female", "BMI": 25.3, "Children": 3, "Smoker": "Smoker", "Insurance_cost": 8886.0}
